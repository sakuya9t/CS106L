...
int hello_as() {
    ...
    // as asm block doesn't work for windows here, we are supposed to use __asm block
    // see https://docs.microsoft.com/en-us/cpp/assembler/inline/asm?view=vs-2019
    // todo: rewrite the assembly code using __asm block
